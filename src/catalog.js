...
export const catalog = [
  ...
  op('WSLegislativo', 'retornarProyectoLey', '/proyectos/:boletin', 'single', [p('boletin', 'prmNumeroBoletin', 'string')], 600, { fichaSenado: true }),
  ...
  op('WSLegislativo', 'retornarVotacionDetalle', '/votaciones/:id', 'single', [p('id', 'prmVotacionId', 'int')], 600, { legible: true, votosPerfil: true, fichaVotacion: true }),
